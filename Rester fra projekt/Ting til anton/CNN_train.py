...
class Shared(GaussianMixin, DeterministicMixin, Model):
    def __init__(self, observation_space, action_space, device, clip_actions=False,
        ...
        self.cnn = nn.Sequential(               nn.Conv2d(1, 64, kernel_size=7, stride=4),
                                                nn.ReLU(),
        ...
        self.net = nn.Sequential(nn.Linear(512+25, 512),
                                 nn.ELU(),
                                 nn.Linear(512, 256),
                                 nn.ELU(),
                                 nn.Linear(256, 128),
...
path = "p6/runs/Isaac-Lift-Franka-v0/25-05-07_17-15-40-999839_PPO/checkpoints/agent_30000.pt"
#path = "p6/runs/Isaac-Lift-Franka-v0/25-05-06_13-20-15-176429_PPO/checkpoints/agent_20000.pt"
agent.load(path)
