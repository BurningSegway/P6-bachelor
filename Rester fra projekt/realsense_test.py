...
# Retrieve the active pipeline profile
profile = pipeline.get_active_profile()

# Access the depth stream's video stream profile
...
print(f"  Principal Point (ppx): {depth_intrinsics.ppx}")
print(f"  Principal Point (ppy): {depth_intrinsics.ppy}")
