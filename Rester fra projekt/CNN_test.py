...
class Shared(GaussianMixin, DeterministicMixin, Model):
    def __init__(self, observation_space, action_space, device, clip_actions=False,
        ...
        self.net = nn.Sequential(nn.Linear(1569, 512),
                                 nn.ELU(),
                                 nn.Linear(512, 256),
                                 nn.ELU(),
                                 nn.Linear(256, 128),
...
#    "group": "Franka-Lift-PPO",                     #Man kan gruppere sine runs, smart hvis man tester forksellige ting af, og skal have et samlet overblik over netop dem
...
#path = "p6/runs/Isaac-Lift-Franka-v0/25-04-08_13-59-46-715123_PPO/checkpoints/best_agent.pt"
#agent.load(path)
